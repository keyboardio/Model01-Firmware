...
const Key keymaps[][ROWS][COLS] PROGMEM = {
  ...
  (___,      Key_F1,           Key_F2,      Key_F3,            Key_F4,        Key_F5,           XXX,
   Key_Tab,  ___,              Key_mouseUp, Key_mouseScrollDn, Key_mouseBtnR, Key_mouseWarpEnd, Key_mouseWarpNE,
   Key_Home, Key_mouseL,       Key_mouseDn, Key_mouseR,        Key_mouseBtnL, Key_mouseWarpNW,
   Key_End,  Key_PrintScreen,  Key_Insert,  Key_mouseScrollUp, Key_mouseBtnM, Key_mouseWarpSW,  Key_mouseWarpSE,
