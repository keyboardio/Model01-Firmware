...
KEYMAP_STACKED
  (___,			          Key_frb_Quote,		Key_frb_DeOQuote,	Key_frb_DeCQuote,	Key_frb_Oparenthesi,	Key_frb_Cparenthesi,	Key_frb_Dollar,
   ...
   Key_LeftControl, Key_Backspace, Key_LeftShift, Key_RightGui,
   ShiftToLayer(FUNCTION),

   Key_frb_Percent, Key_frb_At,			Key_frb_Plus,		Key_frb_Minus,	Key_frb_Slash,		Key_frb_Multiply,	Key_frb_Equals,
   Key_Tab,		      Key_frb_Circumflex,	Key_frb_V,	Key_frb_D,			Key_frb_L,				Key_frb_J,				Key_frb_Z,
						        Key_frb_C,			Key_frb_T,			Key_frb_S,			Key_frb_R,				Key_frb_N,				Key_frb_M,
   Key_LeftGui,		Key_frb_Question,	Key_frb_Q,		Key_frb_G,			Key_frb_H,				Key_frb_F,				Key_frb_W,
   Key_RightControl, Key_RightShift, Key_Spacebar, Key_frb_ALTGR,
   ShiftToLayer(FUNCTION))
